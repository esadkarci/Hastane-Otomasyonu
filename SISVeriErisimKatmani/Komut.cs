...
namespace SISVeriErisimKatmani
{
    internal class Komut
    {
        ...
        ///<summary>
        ///Verilen değerlerle bir yeni parametre oluşturulur.
        /// </summary>
        ...
        ///<summary>
        ///Verilen değerlerle yeni bir out parametre oluşturulur
        /// </summary>
        ...
        internal static int İnt32Getir(SqlDataReader rdr, string alan)
        {
            int veri = -1;
            int indeks = rdr.GetOrdinal(alan);
            if (!rdr.IsDBNull(indeks))
